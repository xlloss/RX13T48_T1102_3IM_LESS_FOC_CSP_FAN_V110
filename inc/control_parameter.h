...
#define     CP_IQ_PI_KI                (0.15)                  /* integral gain for delta-axis current PI control */
...
#define     CP_MAX_SPEED_RPM           (2300)                  /* max speed [rpm] (mechanical angle) */
#define     CP_MIN_SPEED_RPM           (600)                   /* min speed [rpm] (mechanical angle) */
