...
********************************************************************************/
#define     MP_POLE_PAIRS                   (1)                      /* number of pole pairs */
#define     MP_STATOR_RESISTANCE            (25.0f)                  /* stator resistance[ohm] */
#define     MP_ROTOR_RESISTANCE             (12.5f)                  /* rotor resistance [ohm] */
